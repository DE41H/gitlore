    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        blank=True, editable=False, max_length=270, unique=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genres",
                    models.ManyToManyField(related_name="series", to="series.genre"),
                ),
                (
                    "likes",
                    models.ManyToManyField(
                        blank=True,
                        related_name="liked_series",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="chapter",
            index=models.Index(
                fields=["series", "canon"], name="chapter_series_canon_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="chapter",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("canon", False),
                    models.Q(("canon", True), ("status", "done")),
                    _connector="OR",
                ),
